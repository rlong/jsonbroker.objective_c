...
-(void)testMd5HashOfData {
	...
	XCTAssertTrue( [@"939e7578ed9e3c518a452acee763bce9" isEqualToString:response], @"actual = %@", response );
	...
	XCTAssertTrue( [@"39aff3a2bab6126f332b942af96d3366" isEqualToString:response], @"actual = %@", response );
	...
	input = [stringInput dataUsingEncoding:NSUTF8StringEncoding];
	response = [JBSecurityUtilities md5HashOfData:input];
	XCTAssertTrue( [@"6629fae49393a05397450978507c4ef1" isEqualToString:response], @"actual = %@", response );
